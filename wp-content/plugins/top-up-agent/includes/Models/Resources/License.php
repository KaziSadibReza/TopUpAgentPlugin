...
namespace TopUpAgent\Models\Resources;

use TopUpAgent\Abstracts\ResourceModel as AbstractResourceModel;
use TopUpAgent\Interfaces\Model as ModelInterface;
use TopUpAgent\Repositories\Resources\LicenseActivations ;
use stdClass;
use DateTime;
use DateTimeZone;
...
class License extends AbstractResourceModel implements ModelInterface
{
    ...
    {
        return apply_filters('tua_decrypt', $this->licenseKey);
    }
