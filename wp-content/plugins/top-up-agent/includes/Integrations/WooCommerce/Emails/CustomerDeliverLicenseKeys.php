...
class CustomerDeliverLicenseKeys extends WC_Email
{
    ...
    function __construct()
    {
        ...
        $this->id          = 'tua_email_customer_deliver_license_keys';
        $this->title       = __('Deliver license keys', 'top-up-agent');
        $this->description = __('A manual email to send out license keys to the customer.', 'top-up-agent');

        // For admin area to let the user know we are sending this email to customers.
        $this->customer_email = true;
        $this->heading        = __('License key delivery', 'top-up-agent');
        ...
        // Template paths.
        $this->template_html  = 'emails/tua-email-customer-deliver-license-keys.php';
        $this->template_plain = 'emails/plain/tua-email-customer-deliver-license-keys.php';
        $this->template_base  = TUA_TEMPLATES_DIR;

        // Action to which we hook onto to send the email.
        add_action('tua_email_customer_deliver_license_keys', array($this, 'trigger'));
