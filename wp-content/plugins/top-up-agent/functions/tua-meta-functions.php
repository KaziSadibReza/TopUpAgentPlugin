 ...
 * @return mixed|bool
 */
function tua_add_license_meta($licenseId, $metaKey, $metaValue)
{
 ...
 */
function tua_get_license_meta($licenseId, $metaKey, $single = false)
{
    $license = LicenseResourceRepository::instance()->find($licenseId);
 ...
 * @return bool
 */
function tua_update_license_meta($licenseId, $metaKey, $metaValue, $previousValue = null)
{
    $license = LicenseResourceRepository::instance()->find($licenseId);
 ...
 * @return bool
 */
function tua_delete_license_meta($licenseId, $metaKey, $metaValue = null)
{
    $license = LicenseResourceRepository::instance()->find($licenseId);
