document.addEventListener('DOMContentLoaded', function(event) {
    ...
    var licenseTable = {
        btnHideLicense: document.querySelectorAll('.tua-license-key-hide'),
        btnShowLicense: document.querySelectorAll('.tua-license-key-show'),
        btnCopyToClipboard: document.querySelectorAll('code.tua-placeholder'),
        txtCopiedToClipboard: document.querySelector('.tua-txt-copied-to-clipboard'),
        ...
        copyToClipboard: function(el, e) {
            ...
            copied.classList.add('tua-clipboard');
            copied.style.position = 'absolute';
            copied.style.left = e.clientX.toString() + 'px';
            copied.style.top = (window.pageYOffset + e.clientY).toString() + 'px';
            copied.innerText = document.querySelector('.tua-txt-copied-to-clipboard').innerText.toString();
    ...
    var orderLicenses = {
        btnShow: document.querySelectorAll('.tua-license-keys-show-all'),
        btnHide: document.querySelectorAll('.tua-license-keys-hide-all'),
            ...
            for (let i = 0; i < this.btnShow.length; i++) {
                ...
                btnShow.addEventListener('click', function() {
                    ...
                    jQuery.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'tua_show_all_license_keys',
                        ...
                        success: function(response) {
                            ...
                            for (const id in licenseKeys) {
                                ...
                                const licenseKey = document.querySelector('.tua-placeholder[data-id="' + id + '"]');
            ...
            for (let i = 0; i < this.btnHide.length; i++) {
                ...
                btnHide.addEventListener('click', function() {
                    ...
                    for (const id in licenseKeyIds) {
                        ...
                        const licenseKey = document.querySelector('.tua-placeholder[data-id="' + licenseKeyIds[id] + '"]');
