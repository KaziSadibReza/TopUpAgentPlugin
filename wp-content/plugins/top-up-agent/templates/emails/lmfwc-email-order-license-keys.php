 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/tua-email-order-license-keys.php.
 *
                ...
                ?>
                    <tr>
                        ...
                        <?php if ($license->getExpiresAt()): ?>
                            <?php
                                try {
                                    $date = wp_date( tua_expiration_format(), strtotime( $license->getExpiresAt() ) );
                                } catch (Exception $e) {
                                }
                            ?>
