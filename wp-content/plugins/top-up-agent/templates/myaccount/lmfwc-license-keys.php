 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/myaccount/tua-license-keys.php.
 *
        ...
        foreach ($row['keys'] as $license):
            ...
            <tr>
                <td colspan="<?php echo ($license->getExpiresAt()) ? '1' : '2'; ?>">
                    <span class="tua-myaccount-license-key"><?php echo esc_html($license->getDecryptedLicenseKey()); ?></span>
                </td>
                <?php if ($license->getExpiresAt()): ?>
                    ...
                    ?>
                    <td>
                    <span class="tua-myaccount-license-key"><?php printf('%s <strong>%s</strong>', esc_html($valid_until), esc_html($date)); ?></span>
                    </td>
                <?php endif; ?>
            </tr>
        <?php endforeach; ?>
