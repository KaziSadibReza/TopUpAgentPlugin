...
return array(
    ...
    'TopUpAgent\\Abstracts\\IntegrationController' => $baseDir . '/includes/Abstracts/IntegrationController.php',
    'TopUpAgent\\Abstracts\\ResourceModel' => $baseDir . '/includes/Abstracts/ResourceModel.php',
    'TopUpAgent\\Abstracts\\ResourceRepository' => $baseDir . '/includes/Abstracts/ResourceRepository.php',
    'TopUpAgent\\Abstracts\\RestController' => $baseDir . '/includes/Abstracts/RestController.php',
    'TopUpAgent\\Abstracts\\Singleton' => $baseDir . '/includes/Abstracts/Singleton.php',
    'TopUpAgent\\AdminMenus' => $baseDir . '/includes/AdminMenus.php',
    'TopUpAgent\\AdminNotice' => $baseDir . '/includes/AdminNotice.php',
    'TopUpAgent\\Api\\Authentication' => $baseDir . '/includes/Api/Authentication.php',
    'TopUpAgent\\Api\\Setup' => $baseDir . '/includes/Api/Setup.php',
    'TopUpAgent\\Api\\V2\\Licenses' => $baseDir . '/includes/Api/V2/Licenses.php',
    'TopUpAgent\\Controllers\\ApiKey' => $baseDir . '/includes/Controllers/ApiKey.php',
    'TopUpAgent\\Controllers\\Dropdowns' => $baseDir . '/includes/Controllers/Dropdowns.php',
    'TopUpAgent\\Controllers\\License' => $baseDir . '/includes/Controllers/License.php',
    'TopUpAgent\\Crypto' => $baseDir . '/includes/Crypto.php',
    'TopUpAgent\\Enums\\ColumnType' => $baseDir . '/includes/Enums/ColumnType.php',
    'TopUpAgent\\Enums\\LicenseSource' => $baseDir . '/includes/Enums/LicenseSource.php',
    'TopUpAgent\\Enums\\LicenseStatus' => $baseDir . '/includes/Enums/LicenseStatus.php',
    'TopUpAgent\\Export' => $baseDir . '/includes/Export.php',
    'TopUpAgent\\Import' => $baseDir . '/includes/Import.php',
    'TopUpAgent\\Integrations\\WooCommerce\\Controller' => $baseDir . '/includes/Integrations/WooCommerce/Controller.php',
    'TopUpAgent\\Integrations\\WooCommerce\\Email' => $baseDir . '/includes/Integrations/WooCommerce/Email.php',
    'TopUpAgent\\Integrations\\WooCommerce\\Emails\\CustomerDeliverLicenseKeys' => $baseDir . '/includes/Integrations/WooCommerce/Emails/CustomerDeliverLicenseKeys.php',
    'TopUpAgent\\Integrations\\WooCommerce\\Emails\\CustomerPreorderComplete' => $baseDir . '/includes/Integrations/WooCommerce/Emails/CustomerPreorderComplete.php',
    'TopUpAgent\\Integrations\\WooCommerce\\Emails\\Templates' => $baseDir . '/includes/Integrations/WooCommerce/Emails/Templates.php',
    'TopUpAgent\\Integrations\\WooCommerce\\MyAccount' => $baseDir . '/includes/Integrations/WooCommerce/MyAccount.php',
    'TopUpAgent\\Integrations\\WooCommerce\\Order' => $baseDir . '/includes/Integrations/WooCommerce/Order.php',
    'TopUpAgent\\Integrations\\WooCommerce\\ProductData' => $baseDir . '/includes/Integrations/WooCommerce/ProductData.php',
    'TopUpAgent\\Integrations\\WooCommerce\\Stock' => $baseDir . '/includes/Integrations/WooCommerce/Stock.php',
    'TopUpAgent\\Interfaces\\IntegrationController' => $baseDir . '/includes/Interfaces/IntegrationController.php',
    'TopUpAgent\\Interfaces\\Model' => $baseDir . '/includes/Interfaces/Model.php',
    'TopUpAgent\\Interfaces\\ResourceRepository' => $baseDir . '/includes/Interfaces/ResourceRepository.php',
    'TopUpAgent\\Lists\\APIKeyList' => $baseDir . '/includes/Lists/APIKeyList.php',
    'TopUpAgent\\Lists\\LicensesList' => $baseDir . '/includes/Lists/LicensesList.php',
    'TopUpAgent\\Logger' => $baseDir . '/includes/Logger.php',
    'TopUpAgent\\Main' => $baseDir . '/includes/Main.php',
    'TopUpAgent\\Migration' => $baseDir . '/includes/Migration.php',
    'TopUpAgent\\Models\\Resources\\ApiKey' => $baseDir . '/includes/Models/Resources/ApiKey.php',
    'TopUpAgent\\Models\\Resources\\License' => $baseDir . '/includes/Models/Resources/License.php',
    'TopUpAgent\\Models\\Resources\\LicenseMeta' => $baseDir . '/includes/Models/Resources/LicenseMeta.php',
    'TopUpAgent\\Repositories\\Resources\\ApiKey' => $baseDir . '/includes/Repositories/Resources/ApiKey.php',
    'TopUpAgent\\Repositories\\Resources\\License' => $baseDir . '/includes/Repositories/Resources/License.php',
    'TopUpAgent\\Repositories\\Resources\\LicenseMeta' => $baseDir . '/includes/Repositories/Resources/LicenseMeta.php',
    'TopUpAgent\\Repositories\\Users' => $baseDir . '/includes/Repositories/Users.php',
    'TopUpAgent\\Settings' => $baseDir . '/includes/Settings.php',
    'TopUpAgent\\Settings\\General' => $baseDir . '/includes/Settings/General.php',
    'TopUpAgent\\Settings\\Tools' => $baseDir . '/includes/Settings/Tools.php',
    'TopUpAgent\\Settings\\WooSettings' => $baseDir . '/includes/Settings/WooSettings.php',
    'TopUpAgent\\Setup' => $baseDir . '/includes/Setup.php',
);
