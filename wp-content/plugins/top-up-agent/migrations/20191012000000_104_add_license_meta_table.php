...
if ($migrationMode === Migration::MODE_UP) {
    ...
    $settingsGeneral = get_option('tua_settings');

    if ($settingsGeneral) {
        add_option('tua_settings_general', $settingsGeneral);
        delete_option('tua_settings');
    }
}
...
if ($migrationMode === Migration::MODE_DOWN) {
    ...
    $settingsGeneral = get_option('tua_settings_general');

    if ($settingsGeneral) {
        add_option('tua_settings', $settingsGeneral);
